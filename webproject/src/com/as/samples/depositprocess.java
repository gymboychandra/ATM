...
import java.sql.*;
/**
 * Servlet implementation class depositprocess
 */
...
public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     float amount=Float.parseFloat(request.getParameter("damt"));
     String acctyp=request.getParameter("actype");
    	 ...
    	 String sql1="SELECT * FROM accdetails where loginid='"+ userid +"' and pin='"+ pass +"' and acctype='"+ acctyp +"' ";
	    	...
	    	con.setAutoCommit(false);
    	     if(rs.next())
    	     {
    			...
    			System.out.println("inside deposit"+currentbal+" "+amount);
